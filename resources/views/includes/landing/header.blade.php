<section
    ...
    <div class="navbar-1-1" style="font-family: 'Poppins', sans-serif">
        ...
        <div class=" mx-auto flex flex-wrap flex-row items-center justify-between">
            <a href="{{ route('index.landing') }}" class="flex text-3xl font-bold items-center">
                SERV
            </a>
            ...
            <div class="hidden lg:flex lg:items-center lg:w-auto w-full lg:ml-auto lg:mr-auto flex-wrap items-center text-base justify-center"
                ...
                <nav
                    ...
                    <a href="{{ route('index.landing') }}" class="block {{ request()->is('/') ? 'nav-link active font-medium' : 'nav-link text-serv-text' }}">Home</a>
                    ...
                    @auth 
                        ...
                        <a href="{{ route('dashboard.index') }}" class="block lg:hidden nav-link text-serv-text">Dashboard</a>
                ...
                <div @click.away="open = false" class="hidden lg:block relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute right-0 w-full mt-2 origin-top-right rounded-md shadow-lg md:w-48">
                        ...
                        <div class="px-2 py-2 bg-white rounded-md shadow dark-mode:bg-gray-800">
                            <a class="block px-4 py-2 mt-2 text-sm bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="{{ route('dashboard.index') }}">
                                Dashboard
                            </a>
