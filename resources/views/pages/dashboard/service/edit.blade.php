        ...
        <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex p-0 list-none">
                <li class="flex items-center">
                    <a href="{{ route('service.index') }}" class="text-gray-400">My Services</a>
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                            ...
                                            <div class="grid grid-cols lg:grid-cols-3 md:grid-cols-2 gap-4">
                                                @forelse ($thumbnail_service as $thumbnail_item)
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="file" placeholder="thumbnail" name="{{ 'thumbnails[' . $thumbnail_item->id . ']' }}" id="thumbnails" autocomplete="thumbnails" class="block w-full py-3 pl-5 mt-3 border-gray-300 rounded-md shadow-sm focus:ring-green-500 sm:text-sm">
                                                    </div>
                                                @empty
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            @forelse ($tagline as $tagline_item)
                                                <input placeholder="Tagline" type="text" name="{{ ('taqlines['.$tagline_item->id.']') }}" id="taqlines" autocomplete="taqlines" class="block w-full py-3 mt-1 border}}-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $tagline_item->taqline ?? '' }}" required>
                                            @empty
                                                {{-- empty --}}
                                            @endforelse
...
@push('after-script')
    ...
    <script type="text/javascript">
        ...
        $("#addServicesRow").click(function() {
            var html = '';
            html += '<input placeholder="Keunggulan Service" type="text" name="advantage-service[]" id="inputFormServicesRow" autocomplete="advantage-service" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>';
    ...
    <script type="text/javascript">
        ...
        $("#addTaglineRow").click(function() {
            var html = '';
            html += '<input placeholder="Tagline" type="text" name="taqline[]" id="taqline" autocomplete="taqline" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>';
