                                        ...
                                        <td class="w-1/3 px-1 py-5">
                                            <div class="flex items-center text-sm">
                                                <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                    ...
                                                    @if (Auth::user()->detail_user()->first()->photo != null || '')
                                                        <img src="{{ url(Storage::url(Auth::user()->detail_user()->first()->photo)) }}" alt="photo profile" class="object-cover w-12 h-12 mr-3 rounded-full">
                                                    @else
                                                        <svg class="object-cover w-12 h-12 mr-3 rounded-full" fill="currentColor" viewBox="0 0 24 24">
                                                            <path d="M24 20.993V24H0v-2.996A14.977 14.977 0 0112.004 15c4.904 0 9.26 2.354 11.996 5.993zM16.002 8.999a4 4 0 11-8 0 4 4 0 018 0z" />
                                                        </svg>
                                                    @endif
