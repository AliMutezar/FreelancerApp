                        ...
                        <div x-show.transition.duration.500ms="tab === 'seller'" class="leading-8 text-md">
                                ...
                                <div class="flex items-center col-span-12 p-2 lg:col-span-6">
                                    <div class="flex items-center space-x-4">
                                        ...
                                        @if ($service->user->detail_user->photo != null || '')
                                            <img src="{{ url(Storage::url($service->user->detail_user->photo)) }}" class="w-20 h-20 object-cover rounded-full" alt="photo profile" loading="lazy">
                                        @else
                                            <svg class="w-20 h-20 object-cover rounded-full" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="mb-8 skills">
                                @forelse ($tagline as $item)
                                    <li class="pl-10 my-2">{{ $item->taqline }}</li>
                                @empty
                                    {{-- empty --}}
                                @endforelse
                            </div>
            ...
            <aside class="p-4 lg:col-span-4 md:col-span-12 md:pt-0">
                ...
                <div class="mb-4 border rounded-lg border-serv-testimonial-border">
                    ...
                    <div class="flex items-start px-4 pt-6">
                        ...
                        @if ($service->user->detail_user->photo != null || '')
                            <img src="{{ url(Storage::url($service->user->detail_user->photo)) }}" class="object-cover w-16 h-16 mr-4 rounded-full" alt="photo profile" loading="lazy">
                        @else
                    ...
                    <div class="px-4 pb-4 booking">
                        ...
                        @guest
                            <a onclick="toggleModal('loginModal')" class="block px-12 py-4 my-2 text-lg font-semibold text-center text-white bg-serv-button rounded-xl cursor-pointer">
                                Booking Now
                            </a>
                        @endguest
