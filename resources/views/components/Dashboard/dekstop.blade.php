            ...
            <li class="relative px-6 py-3">
                ...
                @if (
                    ...
                    <a class="inline-flex items-center w-full text-sm font-light transition-colors duration-150 hover:text-gray-800" href="{{ route('service.index') }}">
                        ...
                        <span class="ml-4 font-bold">My Services</span>
            ...
            <li class="relative px-6 py-3">
                ...
                @if (
                    ...
                    <a class="inline-flex items-center w-full text-sm font-light transition-colors duration-150 hover:text-gray-800" href="{{ route('request.index') }}">
                        ...
                        <span class="ml-4 font-bold">My Request</span>
            ...
            <li class="relative px-6 py-3">
                ...
                @if (
                    ...
                    <a class="inline-flex items-center w-full text-sm font-light transition-colors duration-150 hover:text-gray-800" href="{{ route('order.index') }}">
                        ...
                        <span class="ml-4 font-bold">My Orders</span>
            ...
            <li class="relative px-6 py-3">
                ...
                @if (
                    ...
                    <a class="inline-flex items-center w-full text-sm font-light transition-colors duration-150 hover:text-gray-800" href="{{ route('profile.index') }}">
                        ...
                        <span class="ml-4 font-bold">Edit Profile</span>
                    </a>
